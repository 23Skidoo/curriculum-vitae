...
{\it E-mail:} \href{mailto:the.dead.shall.rise@gmail.com}{\texttt{the.dead.shall.rise@gmail.com}}\\
{\it Skype:}  \texttt{viginti\_tres} & {\it WWW:} \url{http://dissocial.st}            \\
\end{tabular}
...
dynamic software watermarking tool suite. Did some work on the antivirus
project.
...
MSc(Eng) in Computer Science, December 2012 (expected)
...
A generic compiler driver, designed to be customizable and extensible. Used to
be a part of the LLVM project.

{\bf Open source}\\ I contributed patches to various open source projects including
Doxygen, LLVM, Boost, el-get, Cabal and mkcabal. I'm
...
with Ocaml, Java, Lua, Assembly (x86/MIPS/AVR), Coq, Scheme, Matlab, SQL, UNIX
shell scripting. \\

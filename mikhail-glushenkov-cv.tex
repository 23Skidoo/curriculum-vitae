...
Added support for sandboxed builds and isolated environments to Cabal, a system
for building and packaging Haskell libraries and programs. Sandboxing is one
part of the proposed solution to the important ``Cabal dependency hell''
problem. My code is integrated into the development version of Cabal.
...
build multiple Cabal packages in parallel. My code ships with Cabal since
version 1.16.
...
MSc(Eng) in Computer Science, December 2013 (expected)
...
Right to work in EU and EFTA countries. Willing to relocate. References
